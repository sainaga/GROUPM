	...
	<div class="container">
		<div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="" method="POST" @submit.prevent="validateCreateEventBeforeSubmit" id="create-event-form" action="/event/create" files="true" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-row">
						    ...
						    <div class="form-group col-md-4">
                             ...
                             <div class="form-group col-md-4" :class="{'has-error': errors.has('selected_date') }">
                              <label for="pick_date">Date</label>
                                <input type="date" v-model="selected_date" v-validate.initial="selected_date" name="date" data-vv-rules="required|after:today" class="form-control" id="pick_date" placeholder="Time For Show" required>
                                  <input name="today" type="date" :value="today" hidden="">
                                  <p class="text-danger" v-if="errors.has('selected_date')">@{{ errors.first('selected_date') }}</p>
                                </div>
						  </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4"></div>
                            <div class="form-group col-md-4">
                              <label for="time">Time: 1930hrs<br> The time of each movie screening event on every date will be set as 1930hrs due to logistical constraints (the room will be used as lecture theatres in the day)</label>
                        ...
                        <div class="form-group row">
						 ...
						 <div class="form-group row" :class="{'has-error': errors.has('description') }">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" v-model="description" v-validate.initial="description" data-vv-rules="required|max:100" name="movie_description" id="movie_description" placeholder="Describe Movie" required></textarea>
